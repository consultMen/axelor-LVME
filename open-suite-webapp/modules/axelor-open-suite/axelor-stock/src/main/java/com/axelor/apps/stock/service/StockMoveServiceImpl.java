...
import com.axelor.apps.stock.db.Nature;
...
public class StockMoveServiceImpl implements StockMoveService {
  ...
  public StockMove createStockMove(
    ...
    syncNatureFromStatus(stockMove);
  ...
  private void syncNatureFromStatus(StockMove stockMove) {
    if (stockMove == null || stockMove.getStatusSelect() == null) return;
    ...
    switch (stockMove.getStatusSelect()) {
      ...
      case StockMoveRepository.STATUS_REALIZED:
        stockMove.setNature(Nature.REEL);
        break;

      case StockMoveRepository.STATUS_CANCELED:
        stockMove.setNature(Nature.ANNULE);
        break;
